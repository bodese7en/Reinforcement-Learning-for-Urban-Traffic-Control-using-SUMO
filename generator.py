            ...
            for car_counter, step in enumerate(car_gen_steps):
                ...
                if straight_or_turn < 0.50:  # choose direction: straight or turn - 50% of times the car goes straight
                    ...
                    if route_straight == 1:
                        ...
                        print('    <vehicle id="ev_0_%i" type="ev" route="W_E" depart="%s" departLane="random" departSpeed="20" />'% (car_counter, step), file=routes )
                else:  # car that turn -50% of the time the car turns
                    route_turn = np.random.randint(1, 7)  # choose random source source & destination
                    if route_turn == 1:
